							...
							<div class="card">
								<div class="card-body">
									...
									<form action="update.do" method="post" enctype="multipart/form-data">
										...
										<div class="row mb-3">
											<div class="col-sm-12">
												<input type="text" name="qna_title" id="qna_title" class="form-control" maxlength="50" value="${qnaBoard.qna_title}">
											</div>
										</div>
										...
										<div class="row mb-3">
											<div class="col-sm-12">
												...
												<c:if test="${!empty qnaBoard.qna_photo}">
													<div id="file_detail">
														(${qnaBoard.qna_photo}) 파일이 등록되어 있습니다. <input type="button"
