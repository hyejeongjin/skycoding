          ...
          <div class="card">
            <div class="card-body">
		      ...
		      <div class="form-check form-check-inline" style="margin-bottom:10px">
  					<input class="form-check-input" type="radio" name="course_cate" id="course_cate0" value="0">
  					<label class="form-check-label" for="course_cate0">HTML</label>
				</div>
				<div class="form-check form-check-inline" style="margin-bottom:10px">
  					<input class="form-check-input" type="radio" name="course_cate" id="course_cate1" value="1">
  					<label class="form-check-label" for="course_cate1">JS</label>
				</div>
				<div class="form-check form-check-inline" style="margin-bottom:10px">
  					<input class="form-check-input" type="radio" name="course_cate" id="course_cate2" value="2">
  					<label class="form-check-label" for="course_cate2">JAVA</label>
				</div>
				<div class="form-check form-check-inline" style="margin-bottom:10px">
  					<input class="form-check-input" type="radio" name="course_cate" id="course_cate3" value="3">
  					<label class="form-check-label" for="course_cate3">DB</label>
				</div>
